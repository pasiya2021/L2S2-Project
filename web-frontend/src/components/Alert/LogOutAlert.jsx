...
// Functional component: LogOutAlert
const LogOutAlert = ({ onCancel, onLogOut }) => {
    ...
    >
      ...
      >
        <div className="flex justify-center mb-4">
          <h3 className="text-3xl font-medium text-gray-800 text-center">Log out</h3>
        </div>
        ...
        <div className="flex justify-center gap-4">
          ...
          <button
            ...
            onClick={onLogOut} // Calls onLogOut function passed as prop
          >
            Log out
          </button>
        </div>
