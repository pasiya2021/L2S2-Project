...
function PopularVegetables() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await fetch('http://localhost:8080/api/product/allproducts/2');
                if (!response.ok) {
    ...
    return (
        <div className="w-full bg-white p-4 rounded-sm border border-gray-200">
            <strong className="text-gray-700 font-medium">Popular Vegetables</strong>
